...
footer p a:hover {
    ...
    <body class="profile-page">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        {{-- <li class="dropdown nav-item">
                          ...
                          <li class="nav-item">
                              <a class="nav-link" href="{{ url('format') }}">
                                  <i class="material-icons">time</i> Ejecicio Tiempo
                              </a>
                          </li>
                          <li class="nav-item">
        ...
        <div class="page-header header-filter" data-parallax="true" style="background-image:url('{{ 'bg.jpeg' }}');"></div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 ml-auto mr-auto">
                           <div class="profile">
                                <div class="avatar">
                                    <img src="{{ 'prof.png' }}" alt="Circle Image" class="img-raised rounded-circle img-fluid">
                                </div>
                                <div class="name">
                                    <h3 class="title">Aarón Balderrama</h3>
                ...
                <div class="tab-pane active text-center gallery" id="studio">
                      <div class="row">
                        <div class="description text-center">
                          <p>Apasionado de la tecnología, con 6 años en el sector profesional, como Desarrollador de Software, Sistemas, y Redes, siempre buscando una proyección hacia el bien común y la satisfacción, siempre en desarrollo constante y en busca del aprendizaje de nuevas tecnologías. </p>
                      </div>
                      </div>
                  </div>
                  <div class="tab-pane text-center gallery" id="contact">
                    <div class="row">
                      <div class="description text-left">
                         <div class="find-widget">
                          Direccion: <a href="#">Tlatelolco Cuauhtemoc CDMX</a>
                         </div>
                         <div class="find-widget">
                           Teléfono:  <a href="#">7711754495</a>
                         </div>
                         
                         <div class="find-widget">
                           Website:  <a href="https://www.abb.com">www.abb.com</a>
                         </div>
                         <div class="find-widget">
                            Horario: <a href="#">Lunes a Viernes: 09:30 AM - 10.30 PM</a>
                         </div>
                    </div>
                    </div>
                </div>
